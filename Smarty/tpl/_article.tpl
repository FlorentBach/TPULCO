...
{if $articles['image']}
	...
	<a href="http://127.0.0.1/TP_PHP_BLOG{$articles['image']}" ><img src="http://127.0.0.1/TP_PHP_BLOG{$articles['image']}" height="75" width="150" /></a>
	</br>
{/if}
...
<div>
Tag : <a  href="index.php?tag={$articles['tag']}" > {$articles['tag']} </a>
</div>
